...
<tr>
<td>메뉴이름</td>
<td><input id="menu_name" name="menu_name" type="text" placeholder="메뉴이름"></td>
</tr>
<tr>
<td>가격</td>
<td><input id="price" name="price" type="number" placeholder="원"></td>
</tr>
<tr>
<td>식당 고유 번호</td>
<td><input name="restaurant_id" type="number" value="${restaurant_id}" readonly="readonly"></td>
</tr>
<tr>
<td>식당 이름</td>
<td><input name="restaurant_name" type="text" value="${restaurant_name}" readonly="readonly"></td>
</tr>
<tr>
<th>카테 고리</th>
